...
public class Nivel2 extends AppCompatActivity {
    ...
    private Button flecha_0_1,flecha_0_2,flecha_0_3,flecha_1_2,flecha_2_4,flecha_3_2,
            flecha_3_6,flecha_3_7,flecha_4_5,flecha_4_6,flecha_5_7, flecha_6_7, n0, n1, n2, n3, n4, n5, n6 ,n7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flecha_3_7 = findViewById(R.id.tres_siete);
        ...
        if(indicadorMov >=2) {
            while (!finish) {
                for (int i = 0; i < A.size(); i++) {
                    try {
                        if (cont != 1 && cont != 2 && cont != 5 && cont != 6) {
                ...
                if (entro) {
                    ...
                    if (cont == 7) {
                        ...
                        buldier.setPositiveButton("ACEPTAR", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Nivel2.this, "ERES UN PERDEDOR :(", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    buldier.setPositiveButton("SIGUIENTE NIVEL", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(Nivel2.this, "El boton de arriba :)", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void flecha_3_7(View view){
        if(indicadorMov <2){
            for (int i = 0; i< A.size(); i++){
                if(A.get(i) == 3 && Aprima.get(i) == 7){
                    A.remove(i);
                    Aprima.remove(i);
                }
            }
            flecha_3_7.setVisibility(View.INVISIBLE);
            flecha_3_7.setEnabled(false);
            indicadorMov ++;
            numMovimientos--;
            numMov.setText(numMovimientos + " movimientos");
            recorrerRamas();
